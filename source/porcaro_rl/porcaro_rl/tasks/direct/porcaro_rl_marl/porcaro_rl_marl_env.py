...
from .porcaro_rl_marl_env_cfg import PorcaroRlMarlEnvCfg


class PorcaroRlMarlEnv(DirectMARLEnv):
    cfg: PorcaroRlMarlEnvCfg

    def __init__(self, cfg: PorcaroRlMarlEnvCfg, render_mode: str | None = None, **kwargs):
