...
class RewardsCfg:
    ...
    swing_amplitude_threshold_deg: float = 3 
    ...
    weight_rest: float = 0.1        # 時間積分項 (Scaleされるので少し大きめでもOK)
    weight_rest_penalty: float = -0.5
    ...
    weight_miss: float = -2.0       # Match Scaleで増幅されるので適度な値に
    weight_double_hit: float = -1.0 # Match Scaleで増幅
